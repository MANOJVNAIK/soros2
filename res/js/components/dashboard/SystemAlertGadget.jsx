...
class SystemAlertsGadget extends Component {
  ...
  edit(){
            ...
            axios.get(baseUrl+'/index.php/Gadgets/system-alerts-gadget/view?&id=' + this.props.data.gadget_data_id, {
            headers: {
 ...
 updateGadget(){
        ...
        let validator = $("#system_alert_gadget_form").validate(this.state.validationOption);
        validator.form();
        ...
        if(!valid){
            ...
            var data = this.serializeObject($('#system_alert_gadget_form'));
            data.sources    =  this.state.sources; 
            data.setpoints  =  this.state.setpoints; 
            data.elements   =  this.state.elements; 
            
           
            axios.put(baseUrl+'/index.php/Gadgets/system-alerts-gadget/update?&id='+this.props.data.gadget_data_id, data, {
            headers: {
            'Content-Type': 'application/json',
                    'X-Access-Token': access_token
            }
 ...
 creatGadget(){
        ...
        const data = this.serializeObject($('#system_alert_gadget_form'));
        ...
        axios.post(baseUrl+'/index.php/Gadgets/system-alerts-gadget/create?&id='+this.props.layoutID, data, {
            headers: {
                'Content-Type': 'application/json',
                'X-Access-Token': access_token
            }
            ...
            swal("Sucess",'System Alert created Successfully','success');
            ...
            this.close();
           swal("Error",'Some problem occured , couldn\'t System Alert Gadget','warning')
  ...
  componentDidMount(){
    ...
    render() {
      ...
      const sizeOption = [{value: 'small' , label :"Small"}];
        ...
        actionBtn =  <div className="col-md-4">
                                            <div className="mt-widget-3">
                                                <div className="mt-head bg-green">
                                                    ...
                                                    <div className="mt-head-desc"> System Alert</div>
      ...
      return (
        ...
        <Modal show={this.state.showModal} onHide={this.close}>
          <Modal.Header closeButton>
            <Modal.Title className="text-center"><span className="caption-subject bold uppercase">System Alert Gadget</span></Modal.Title>
          </Modal.Header>
          <Modal.Body>
              <form id="system_alert_gadget_form" className="form-horizontal has-validation" role="form" onSubmit={(e) => {  e.preventDefault() } }>
					...
					options= {[{label : 'source', value:'source' },{ label : "value" ,value : 'value'}]}
