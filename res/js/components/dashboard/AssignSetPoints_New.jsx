...
handleSubmit(e) {
   ...
   //clearing setpointFiled to resorl jquery error 
   this.setState({setpointField : ''}, () =>{ this.props.onSubmit({ [this.state.element_type] : state}) })
   ;
}
...
console.log('Status type -->',this.props.data.type);
 if(this.props.data.type !== 'binary'){
 setPointStr = <div className="form-group">
            ...
            setPointStr  =  <div>
                                ...
                                <input type="hidden" className="form-control" value={this.state.normal} name="normal" onChange={this.handleInputChange}     />
                             ...
                             <div className="form-group">
                                               ...
                                               ON                                                       
                                                ...
                                                <button className="status-btn green"> On</button>
                                            </div>
                                            </div>
                                             ...
                                             <div className="form-group">
                                               ...
                                               OFF                                                       
                                                ...
                                                <div className="col-md-9">
                                                    <button className="status-btn red">Off</button>
                                            </div>
                                            </div>     
                                </div>    
            }
            ...
            this.setState({setpointField : setPointStr},this.render);
