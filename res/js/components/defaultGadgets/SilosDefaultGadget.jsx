...
class SilosGadget extends Component {
 ...
 updateGadget(){
        ...
        if(!valid){
            ...
            axios.put(baseUrl+'/index.php?r=Gadgets/silos-gadget/update&id='+this.props.data.gadget_data_id, data, {
            headers: {
 ...
 creatGadget(){
        ...
        let validator = $("#silos_gadget_form").validate();
        validator.form();
        let valid = validator.valid();
              ...
              <form id="silos_gadget_form" className="form-horizontal has-validation" role="form" onSubmit={(e) => {  e.preventDefault() } }>
                        ...
                        <div className="form-body">
                            ...
                            <div className="form-group">
                             ...
                             <div className="form-group">
                                <label className="col-md-3 control-label">Number of Silos</label>
                                <div className="col-md-9">
                                    <input type="text" 
                                    name='number_of_silos' 
                                    className="form-control" 
                                     
                                    required 
                                    placeholder="Num of Silos" 
                                    onChange={this.handleInputChange}  
                                    value={this.state.number_of_silos}/> 
                                </div>
                            </div>
