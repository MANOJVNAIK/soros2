...
//   this.onClick            = this.onClick(this);
    ...
    updatelayout(layoutID){
        ...
        var gadgets ;
            ...
            $.ajax({
                type:'POST',
                url : 'http://localhost/yii2/helios-v2/h2o/frontend/web/index.php?r=gadgets-data/index', //have to figure out yii2 routing
                ...
                success:function(msg){
                       ...
                       this.setState({gadgetList : array},this.renderLayout);
    ...
    deleteGadget(id){
            ...
            $.ajax({
                type:'GET',
                url : 'http://localhost/yii2/helios-v2/h2o/frontend/web/index.php?r=gadgets-data/delete', //have to figure out yii2 routing
                data:{ id : id },
                success:function(msg){
    ...
    return (
            ...
            <div className="portlet-title">
                <div className="caption">
                    <i className="fa fa-files-open"></i> Layouts </div>
                    <div className="tools">
