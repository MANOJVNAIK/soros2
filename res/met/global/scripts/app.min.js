...
function buildSelectTag(id,data){
    
    $("#tag-name").html('');
    
    try{
         var queued      = data.queued    !== 'undefined' ? data.queued : {} ;
         var completed   = data.completed !== 'undefined' ? data.completed : {} ;
...
//    console.log(queued[0])            
    ...
    var  queuedArray    = arrayOfJson(queued[0]);
    var  completeArray  = arrayOfJson(completed[0]);
    


    console.log( [{ id: 0, text: 'enhancement',
                    children:queuedArray
          }]);
//
//    console.log(completed);
//    console.log( arrayToJSONObject((completed) ));
...
function arrayOfJson(data){
    
        var array= Array();
        for(i in data )
        {
            array.push(arrayToJSONObject(data[i]))

        }
    
        return array;
}
function arrayToJSONObject(array){
    ...
    for(var i in array)
    {
        JObject[i] = arrayToJSONObject(array[i]);
    }
