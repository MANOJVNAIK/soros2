...
<script type="text/javascript">
    ...
    var gsize = $( "#IdiotLights_gadgetSize" );
    var gname = $( "#IdiotLights_gadgetName" );
    var allFields = $( [] ).add( gname ).add( gtype ).add( detsource ).add( datasource ).add( gsize );
    var gtype = $( "#IdiotLights_gadgetType" );
    var detsource = $( "#IdiotLights_detectorSource" );
    var datasource = $( "#IdiotLights_dataSource" );
