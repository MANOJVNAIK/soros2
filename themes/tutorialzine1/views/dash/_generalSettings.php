	...
	<section>
		...
		<div class="clearfix">
			...
			<div class="buttonset leading">
			    ...
			    <input type="radio" name="button-togglel" id="button-toggle-l3" value="3"  onClick="changeLang('zh_cn','<?php echo Yii::app()->user->getId(); ?>'); " /><label for="button-toggle-l3">Chinese</label>
			</div>
		    </div>
		</div>
		<div class="clearfix">
