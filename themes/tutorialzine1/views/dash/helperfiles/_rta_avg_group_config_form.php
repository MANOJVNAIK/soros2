...
<div class="portlet ui-widget ui-widget-content ui-corner-all">
    ...
    <header class="ui-widget-header ui-corner-top">
        ...
        <h2>Average Group ID</h2>
        <ul class="pagination clearfix leading pull-right" style="position: absolute;right:0px;top:-15px;">

            <li class="skip"><a href="#rta-shift-times">Skip</a></li>
            <li class="prev"><a href="#rta-avg-config">« Prev</a></li>

            <li class="next"><a href="#rta-shift-times">Next »</a></li>
