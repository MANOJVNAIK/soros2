        ...
        <section>
            <form class="form has-validation" onsubmit="moveAhead('#portlet-pane-2','#portlet-pane-1'); return false;" >
                ...
                <div class="clearfix">
                    ...
                    <div class="form-input">
                    	<div class="buttonset leading">
							<input type="radio" name="button-toggle" id="button-toggle-1" value="1" style="left: 0px; top: 0px; height: 20px" onClick="changeLayoutStyle('<?php echo Yii::app()->theme->baseUrl ."/css/cu_grid_";?>', 'thin','<?php echo Yii::app()->user->getId(); ?>'); return false;" /><label for="button-toggle-1" aria-pressed="false" >Thin</label>
