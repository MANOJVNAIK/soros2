  ...
  <script type="text/javascript">
   ...
   //Used by 'dashCreate_logic.js, customizeButtons.setDetectorSource()';
  </script>
...
<section class="main-section grid_8">
 ...
 <div class="main-content">
  <header>
   <h2 id="layout-title">Create/Update Layouts</h2>   
    <p>Create, Update and Delete layout settings using this page. Please note only admins can delete layouts.</p>
  </header>
     ...
     <section class="ui-widget-content ui-corner-bottom">  
      <div class="clearfix">
       ...
       <div style="float:left;width:50%;">
        <span style="width:150px;">Create a new layout :</span>
         <input type="hidden" id="addNewLayout_btn_click" value="false" />
		  <button class="button" id="addNewLayout"> New layout</button>
		  <button class="button" id="addNewGadget" name="addNewGadget">+ Gadget</button>
    		<input id="addNewGadget_hidden" type="hidden" value="hide" />
		  <button class="button" id="manageLayout"> Administrator</button>
		</div>
			 
       <div style="float:left;width:50%;">
        <span style="width:150px;">Update/Switch layout:</span>
    ...
    <div class="clearfix"><br/>		 	 
		...
		<div class="portlet ui-widget ui-widget-content ui-corner-all ">
		 <header class="ui-widget-header ui-corner-top" id="buttonsHolder">
		 	<h2 id="layout_workshop_h2">Layout Workshop
			 <div id="layoutbuttons" style="float:right;display:none;">
			 	 ...
			 	 <span class="ui-button-icon-primary ui-icon ui-icon-plus"></span><span class="ui-button-text" id="addDivBut">Add Gadget</span>
			 	</button>
         		 ...
         		 <span class="ui-button-text" id="all_save" onclick="saveLayoutGadget()">Save</span>
		 	 	</button>
		 	 </div> 
 ...
 <!-- New Layout -->
  <div id="dialog-form-new" title="Create a New Layout">  
   <section class="clearfix">
     <h5>Let's start with giving a name to this new layout.</h5>
	 <div class="grid_8"> 
		<div class="portlet"> 
			<form class="form has-validation" > 
				...
				<div class="clearfix">
					<label for="form-gadgetName" class="form-label">
					 	Layout Name<em>*</em>
				 	 	<small>The name of the Template.</small>
					 </label>
 ...
 <div id="select-gadget" title="Select A Gadget">
  ...
  <ul class="isotope-contacts clearfix">
   <li class="button ui-corner-all index-p" onclick="selectGadget('Alerts')" data-id="66f6d7ff16d37e3bde9643358c98cfe1"> 
    ...
    <div class="fullname">ALERT</div>
    <div class="name"></div>
    <div class="city">Add an alert for</div>
    <div class="email">custom alert</div>
    <div class="bday">notifications.</div>
   </li>
   ...
   <li class="button ui-corner-all index-a" onclick="selectGadget('IdiotLights')"data-id="0e0678531c72bfefd18ec2eba8cb3ff7">
    ...
    <div class="fullname">LIGHTS</div>
    <div class="name"></div>
    <div class="city">Easy-to-show lights</div>
    <div class="email">can better monitor</div>
    <div class="bday">system settings.</div>
   </li>
   ...
   <li class="button ui-corner-all index-b" onclick="selectGadget('LiveStatus')" data-id="b3869c81ff2c12d0be71b0bcecf70fc4">
    ...
    <div class="fullname">STATUS</div>
    <div class="name"></div>
    <div class="city">Keep an eye on elemental</div>
    <div class="email">percentages, averages,</div>
    <div class="bday">and real-time statistics.</div>
   </li>
   ...
   <li class="button ui-corner-all index-p" onclick="selectGadget('Charts')" data-id="fac966a9a5a4b273ac162dbe130bc9ab">
    ...
    <div class="fullname">PLOT/GRAPH</div>
    <div class="name"></div>
    <div class="city">Uncover correlations</div>
    <div class="email">between different</div>
    <div class="bday">sets of data.</div>
   </li>
   ...
   <li class="button ui-corner-all index-a" onclick="selectGadget('Tables')" data-id="4975cfc1717e0f7f1f8387bc3d78b78e">
    ...
    <div class="fullname">TABLES</div>
    <div class="name"></div>
    <div class="city">Tables help you</div>
    <div class="email">derive intelligence</div>
    <div class="bday">from multiple sources.</div>
   </li>
                                                      
   <li class="button ui-corner-all index-k" onclick="#" data-id="bcd25054edf383c3f5154bf98084f8a6">
    <div class="photo gauge" ><div></div></div>
    <div class="fullname">Not Available!</div>
    <div class="name"></div>
    <div class="city">Wait for </div>
    <div class="email">Future Updates</div>
    <div class="bday"></div>
   </li>                                       
 ...
 <div id="Alerts-dialog-form" title="Specify Gadget Properties">  
  <section class="clearfix"> 
	 ...
	 <div class="grid_6">
        ...
        <div class="clearfix">
			 	 <label for="form-gadgetName" class="form-label">
			 	 	Gadget Name<em>*</em>
			 	 	 <small>Shown as the Gadget header.</small>
			 	 </label>
			 	 <div class="form-input">
			 	...
			 	<div class="clearfix">
			 	 <label for="form-gadgetType" class="form-label">
			 	 	Gadget Type<em>*</em>
			 	 	 <small>Selected the type of Gadget.</small>
			 	 </label>
			 	 <div class="form-input">
			 	...
			 	<div class="clearfix">
			 	  ...
			 	  <label for="form-detectorSource" class="form-label">
			 	   Data Source<em>*</em>
			 	 	  <small>Choose the source of information.</small>
			 	  </label>
			 	  <div class="form-input">
        		...
        		<div class="clear"></div>
			 	<div class="clearfix">
			 	 <label for="form-email" class="form-label">
			 	 	Size<em>*</em>
			 	 	 <small>Choose size for Gadget.</small>
			 	 </label>
         		 <div class="form-input">
   ...
   <section class="clearfix"> 
			 	  ...
			 	  <div class="clearfix">
            		...
            		<input type="hidden" id="Charts_gadget_detector_source" value="" />
             		...
             		<input type="hidden" id="gadget_groupStyle" value="individual" />   
			 	      <label for="form-email" class="form-label">
			 	 	     Chart Style<em>*</em>
			 	 	      <small>Choose the Chart style.</small>
			 	      </label>
				        <div class="form-input">
			 	       <select id="Charts_groupStyle" name="Charts_groupStyle" maxlength="30" onchange="customizeButtons.setGroupStyle(this.value)"> 
			 	 	      ...
			 	 	      <option value="hgrouped">Horizontal Set</option>
		               </select>
			 	      </div> 
			 	    </div>	
             		...
             		<input type="hidden" id="gadget_chartStyle" value="simple" />   
			 	      <label for="form-email" class="form-label">
			 	 	     Grouping Style<em>*</em>
			 	 	      <small>Choose the display style.</small>
			 	      </label>
				        <div class="form-input">
			 	       <select id="Charts_chartStyle" name="Charts_chartStyle" maxlength="30" onchange="customizeButtons.setChartStyle(this.value)"> 
			 	 	      ...
			 	 	      <option value="aspline">Area Spline</option>
			 	 	      <option value="saspline">Selectable Area Spline</option>
		               </select>
			 	      </div> 
			 	    </div>	
             		...
             		<input type="hidden" id="Charts_gadget_data_source" name="Charts_gadget_data_source" value="" />   
			 	      <label for="form-email" class="form-label">
			 	 	     Choose Items<em>*</em>
			 	 	      <small>Choose the item set.</small>
			 	      </label>
				        <div class="form-input">
    ...
    <div class="grid_2" style="float:left !important;margin-left:40px;">
    		<table id="chartElementsTable" style="width:200px !important;">
    			<thead>
    			<tr>
    			<th class="ui-widget-header ui-corner-top">Elements</th>
			...
			<p><strong>Double click on (X) to delete items.</strong></p>
    </div>
  ...
  <p>
    Each button represents individual display blocks you want to monitor. 
     <br/>Click on the button to assign properties to it.</p>
   <section> 
    <input id="hidden_customizeBut_size" value="" type="hidden">
    <input id="hidden_customizeBut_data_source" value="asdf" type="hidden"> 
         
    <ul class="isotope-widgets isotope-container" id="Alerts_ul_customizeBut" style="min-height:200px !important;">
 ...
 <div id="IdiotLights-dialog-form-customize" title="Status Indicators" >  
  <p>
    Each button represents individual display blocks you want to monitor. 
     <br/>Click on the buttons to assign properties to them.</p>
   <section> 
    <input id="hidden_customizeBut_size" value="" type="hidden">
    <input id="hidden_customizeBut_data_source" value="asdf" type="hidden"> 
    ...
    <div class="clearfix">
     ...
     <div class="form-input" id="alert-form-input">                                
      <select id="Alerts_element_dataItems" class="alertdataItems"  name="dataItems" maxlength="30" onchange="gadgetColors.setChosenDataItem(this.options[this.selectedIndex].text,'Alerts', 'Alerts', 'Alerts')">  
		   <option value="0" selected="selected">Choose Status Option</option>
			 <!--
                ...
                "Next": function(){
                                   ...
                                   var layoutContents = document.getElementById(layoutName).value;    
                                    ...
                                    success: function(stringified){  
                             		   ...
                             		   {
	                             		    $("#ajaxLoadSuccess").html('Layout name already exists!<img src="<?php echo Yii::app()->baseUrl; ?>/images/cancel.png" alt="" />');
	                             		   	return;
										}
...
$("#manageLayout").click(function(){
	window.location= "<?php echo Yii::app()->baseUrl;?>/manager/admin";
