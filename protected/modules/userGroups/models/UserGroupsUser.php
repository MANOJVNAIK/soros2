...
class UserGroupsUser extends CActiveRecord
{
	...
	{
   //Controller::fb("login() here!");    //DEBUGGING.. wikkens..
		if($this->_identity===null)
		{
      //Controller::fb("this->_identity===null");   //DEBUGGING..
      
			if ($mode === 'regular') {
        //Controller::fb("mode === 'regular' ");   //DEBUGGING..
        
				$this->_identity=new UserGroupsIdentity($this->username,$this->password);
        //Controller::fb("this->username is " . $this->username . ", this->password is " . $this->password);
		...
		{
      //echo Controller::fb("Inside UserGroupsUser.php");       //Dec5th: Debugging..
      //echo Controller::fb("Yii::app()->user->name.. taken from UserGroupsIdentity.php.. is " . Yii::app()->user->name );
