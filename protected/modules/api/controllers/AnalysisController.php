...
class AnalysisController extends BaseController {
    ...
    public function actionAverage() {
        ...
        $avg = AnalysisDataProvider::queryAvg($element,date("Y-m-d H:i:s",strtotime($startTime )),date("Y-m-d H:i:s",strtotime($endTime) ));
    ...
    public function actionIntervalAverage() {
        ...
        $interval = Yii::app()->request->getParam('interval', 1);
        $startTimeString = date("Y-m-d H:i:s", time() - ($interval * 60 * 60));
        $endTimeString = date("Y-m-d H:i:s");
        $startTime = Yii::app()->request->getParam('start_time', $startTimeString);
        $endTime = Yii::app()->request->getParam('end_time',$endTimeString);
        $selectSql = [];
