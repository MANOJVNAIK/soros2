...
class MoniterColumnsController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['MoniterColumns']))
		{
			$model->attributes=$_POST['MoniterColumns'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('MoniterColumns');
